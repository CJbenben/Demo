...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TXBaseKit/TXBaseKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TXCategoryKit/TXCategoryKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TXCommonKit/TXCommonKit.framework"
